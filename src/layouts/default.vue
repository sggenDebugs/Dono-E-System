<template>
    <div class="bg-[#E5E5E5]">
                ...
                <div class="self-stretch w-screen flex justify-between items-center">
                    ...
                    <div class="w-[260px] h-[56px] p-3 mr-3.5 mt-2 bg-[#f2f2f0] rounded-xl border border-[#d4d3d3] justify-start items-center gap-2.5 inline-flex">
                        ...
                        <div class="w-[154px] h-[31px] justify-center items-center flex">
                            <div class="w-[154px] h-[31px] text-center text-[#1b3c59] text-xl font-medium font-['Ubuntu']">Juan Dela Cruz</div>
                        </div>
        ...
        <div class="self-stretch absolute top-[70px] right-0 m-4">
            <div class="w-[1190px] border border-[#456173]"></div>
        </div>

<table>
  <thead>
    <tr class="self-stretch sm:justify-center absolute w-[1200px] top-[90px] right-1.5 mx-2 flex flex-row">
        <th class="w-[400px] h-[46px] px-2.5 py-[15px] my-2 mx-3.5 bg-[#a6ed8e] justify-center items-center inline-block">
        ...
        <th class="w-[400px] h-[46px] px-2.5 py-[15px] my-2 mx-3.5 bg-[#a6ed8e] justify-center items-center inline-block">
            ...
            <div class="container w-[1180px] h-[600px] absolute top-[60px] left-[50%] transform -translate-x-1/2 flex justify-center items-center">
                <slot />
            </div>
