<template>
    <div class="bg-[#E5E5E5]">
        ...
        <div class="h-screen w-[314px] bg-[#1b3c59] relative">
                ...
                <div class="w-screen flex justify-between items-center">
                    ...
                    <div class="w-[260px] h-[56px] p-3 mr-3.5 mt-2 bg-[#f2f2f0] rounded-xl border border-[#d4d3d3] justify-start items-center gap-2.5 inline-flex">
                        ...
                        <img class="w-[23px] h-[23px] relative" src="/assets/img/Dropdown.png">
                    </div>
            ...
            <div class="flex flex-col justify-center items-center text-3xl absolute inset-0">
        ...
        <div class="absolute top-[70px] right-0 m-4">
            <div class="w-[1021px] h-[0px] border border-[#456173]"></div>
        </div>

<table>
  <thead>
    <tr class="absolute w-[1024px] top-[90px] right-1.5 mx-2 flex flex-row">
        <th class="w-[312px] h-[46px] px-2.5 py-[15px] my-2 mx-3.5 bg-[#a6ed8e] justify-center items-center inline-block">
            <div class="text-center text-[#1b3c59] text-xl font-light font-['Ubuntu'] mt-[-6px]">
                DISPOSE old tech.
            </div>
        </th>
