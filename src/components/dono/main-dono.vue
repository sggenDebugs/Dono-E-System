...
<template>
    <div>
        ...
        <div class="absolute w-full top-[12%] left-0">
            ...
            <p class="text-[#1B3C59] text-xl font-medium mb-4">
                Recently Added (0)
            </p>
            <div class="self-stretch w-[97.4%] absolute top-[35%]">
                <div class="w-full border border-[#d4d3d3]"></div>
            </div>

            <div class="flex justify-center items-center">
                <p class="w-[16rem] text-center text-[#456173] text-xl font-medium">No Items Listed</p>
            </div>
